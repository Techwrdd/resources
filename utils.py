...
from info import VERIFY_SHORTNER, MALTI_BUTTONS, SHORT_URL2, SHORT_API2, SHORTENER, LONG_DROPLINK_URL, STREAM_LONG, STREAM_API, STREAM_SITE, STREAM_URL, DIRECT_GEN, DIRECT_GEN_DB, DIRECT_GEN_URL, AUTH_CHANNEL, VERIFY_1_SHORTENERS, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORT_URL, SHORTENER_API, SHORTENER_API2, SHORTENER_WEBSITE, SHORTENER_WEBSITE2
