...
from info import VERIFY_LOG, GRP_LNK, CHNL_LNK, VERIFY, CHANNELS, MALIK5, MALIK, TUTORIAL_LINK_1, TUTORIAL_LINK_2, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, START_MESSAGE, FORCE_SUB_TEXT, SUPPORT_CHAT
...
#New_Verified_User_complete"""
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("JOIN OUR UPDATE CHANNEL",url="https://t.me/cinemica"),]]),parse_mode=enums.ParseMode.HTML)#"You are now verified for next 24 hours. Continue asking movies")
        return
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('JOIN OUR UPDATE CHANNEL', url=CHNL_LNK)
                  ]]
